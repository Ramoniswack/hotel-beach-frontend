            ...
            <form onSubmit={handleSubmit}>
              <Tabs.Root defaultValue="basic" className="w-full">
                ...
                <Tabs.List className="flex border-b border-gray-200 bg-gray-50 px-6 overflow-x-auto">
                  <Tabs.Trigger
                    value="basic"
                    className="px-4 py-3 text-sm font-medium text-gray-600 hover:text-gray-900 border-b-2 border-transparent data-[state=active]:border-green-600 data-[state=active]:text-green-600 transition-colors flex items-center gap-2 whitespace-nowrap"
                  >
                    <FileText size={16} />
                    Basic Info
                  </Tabs.Trigger>
