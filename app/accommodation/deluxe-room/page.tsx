    ...
    <div className="bg-white">
      ...
      <section className="relative h-[70vh] w-full overflow-hidden flex flex-col items-center justify-center">
        ...
        <div className="relative z-10 text-center text-white">
          <h1 className="text-[60px] md:text-[80px] font-bold tracking-tight mb-4">Deluxe Room</h1>
          <p className="text-[12px] uppercase tracking-[0.4em] font-medium opacity-90 mb-12">Great for business trip</p>
        ...
        <div className="bg-white shadow-[0_30px_60px_-15px_rgba(0,0,0,0.1)] p-8 md:p-16 flex flex-col lg:flex-row gap-16">
          ...
          <div className="lg:w-2/3">
            ...
            <div className="space-y-6 text-[#666] text-[15px] leading-[1.8] font-light">
              <p>
                Exercitation photo booth stumptown tote bag Banksy, elit small batch freegan sed. Craft beer elit seitan exercitation, photo booth et 8-bit kale chips proident chillwave deep v laborum. <span className="italic font-normal">Aliquip veniam delectus, Marfa eiusmod Pinterest</span> in do umami readymade swag. Selfies iPhone Kickstarter, drinking vinegar jean vinegar stumptown yr pop-up artisan.
              </p>
              <p>
          ...
          <div className="lg:w-1/3 lg:border-l lg:pl-12 flex flex-col">
            <div className="mb-10">
              ...
              <span className="text-[56px] font-bold text-[#1a1a1a] leading-none tracking-tighter">$249</span>
            </div>
            ...
            <div className="space-y-6 text-[13px] text-[#1a1a1a]">
              ...
              <div className="flex items-center space-x-4">
                ...
                <span className="font-medium">3 Adults 1 Children</span>
              </div>
              <div className="flex items-center space-x-4">
                <svg className="w-6 h-6 text-gray-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="flex items-center space-x-4">
                ...
                <span className="font-medium">Sea view</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="gallery" className="py-24 px-4 overflow-hidden">
        <div className="max-w-[1400px] mx-auto grid grid-cols-1 md:grid-cols-3 gap-6 h-[700px]">
          ...
          <div className="h-full overflow-hidden relative">
            <Image 
              src="https://images.unsplash.com/photo-1601918774946-25832a4be0d6?auto=format&fit=crop&q=80&w=800"
              alt="Gallery 2"
              fill
              className="object-cover transition-transform hover:scale-105 duration-700"
            />
              ...
              <div key={idx} className="group">
                ...
                <div className="text-center">
                  ...
                  <div className="flex items-center justify-between border-t border-gray-100 pt-8">
                    ...
                    <a href={room.link} className="text-[11px] font-bold uppercase tracking-widest border-b border-black pb-1 hover:text-[#59a4b5] hover:border-[#59a4b5] transition-colors">
                      View Detail
                    </a>
                  </div>
                </div>
