...
const RetreatSpaH5: React.FC<RetreatSpaH5Props> = ({ section }) => {
  return (
    <section className="relative w-full h-[60vh] sm:h-[70vh] md:h-[80vh] lg:h-[90vh] overflow-hidden flex items-center">
      {/* Background Image with Overlay - Positioned to touch left, leave small space on right */}
      <div className="absolute left-0 top-0 bottom-0 right-[0.5cm] sm:right-[1cm] z-0">
        <Image 
      ...
      <div className="relative z-10 max-w-[1300px] mx-auto px-4 sm:px-6 md:px-8 w-full">
        <div className="max-w-xl sm:max-w-2xl text-white">
          <h2 className="text-3xl sm:text-4xl md:text-[52px] lg:text-[60px] font-bold leading-[1.1] mb-6 sm:mb-8 md:mb-10 tracking-tight drop-shadow-sm">
            {section?.title || 'Visit Our fantastic villas'}
          </h2>
          <p className="text-sm sm:text-[15px] md:text-[16px] leading-[1.7] sm:leading-[1.8] font-normal mb-8 sm:mb-10 md:mb-12 max-w-[450px] sm:max-w-[500px] text-white/90 drop-shadow-sm">
