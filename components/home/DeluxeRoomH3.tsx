      ...
      <div className="w-full lg:w-[450px] p-12 lg:p-20 flex flex-col justify-center text-white">
        ...
        <div>
          <a 
            ...
            className="px-10 py-3 rounded-full border border-white text-[10px] font-bold tracking-[0.25em] uppercase hover:bg-white hover:text-black transition-all duration-300 inline-block"
          >
            view detail
          </a>
        </div>
