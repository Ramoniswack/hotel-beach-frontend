    ...
    <div className="grid grid-cols-1 md:grid-cols-3 w-full h-auto md:h-[300px] mb-8 sm:mb-12 md:mb-16">
      {promotions.map((promo, idx) => (
        <div key={idx} className="relative group overflow-hidden h-[250px] sm:h-[280px] md:h-full">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-6 sm:px-8 md:px-10">
            <h3 className="text-white text-lg sm:text-xl font-bold mb-4 sm:mb-6 drop-shadow-lg leading-tight">
              {promo.title}
            </h3>
            <a 
              href={promo.link || '#'}
              className="text-white text-[9px] sm:text-[10px] font-black uppercase tracking-[0.3em] border-b border-white/50 hover:border-white transition-all pb-1"
            >
              Read More
            </a>
          </div>
